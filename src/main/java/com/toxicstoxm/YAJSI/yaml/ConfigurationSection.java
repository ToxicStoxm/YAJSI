...
public interface ConfigurationSection {
     ...
     * @throws IllegalArgumentException Thrown when a path is null.
     */
     ...
     * <p>
     * If the value is null, the entry will be removed. Any existing entry will be
    ...
    @Nullable
    <T> T getObject(@NotNull String path, @NotNull Class<T> clazz, @Nullable T def);
     ...
     * <p>
     * If the root contains no defaults, or the defaults don't contain a
     ...
     * <p>
     * If the value is null, the value will be removed from the default
     ...
     * @throws IllegalArgumentException Thrown if a path is null.
     */
     ...
     * <p>
     * If the value is null, the comments will be removed. A null entry is an empty
