 ...
 * @author ToxicStoxm
 */
public class SettingsManagerOLD implements SettingsManagerSettings {

    /**
     * Singleton instance of this class.
     */
    private static SettingsManagerOLD instance;
    ...
    public static SettingsManagerOLD getInstance() {
        if (instance == null) {
            instance = new SettingsManagerOLD();
        }
    ...
    /**
     * Configuration class for {@link SettingsManagerOLD}.
     */
    @Builder
