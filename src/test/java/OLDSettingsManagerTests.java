import com.toxicstoxm.YAJSI.old.ManualAdjustmentHelper;
import com.toxicstoxm.YAJSI.old.SettingsManagerOLD;
import com.toxicstoxm.YAJSI.old.YAMLConfiguration;
import com.toxicstoxm.YAJSI.old.YAMLSetting;
...
@YAMLConfiguration()
public class OLDSettingsManagerTests {
    ...
    @YAMLSetting.Ignore
    private SettingsManagerOLD settingsManager;

    public OLDSettingsManagerTests() {}
    ...
    public void testSettingsManagerAPI() {
        settingsManager = SettingsManagerOLD.getInstance();
